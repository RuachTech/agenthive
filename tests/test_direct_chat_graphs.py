...
class TestDirectChatGraphFactory:
    ...
    def mock_agent_factory(self):
        ...
        factory = Mock()
        factory.validate_agent = AsyncMock(return_value={
            "valid": True,
            "errors": [],
            "config": Mock(),
            "capabilities": Mock()
        ...
        factory.get_agent_config = Mock(return_value=AgentConfig(
            name="test_agent",
        ...
        factory.get_agent_capabilities = Mock(return_value=AgentCapabilities(
    ...
    @pytest.mark.asyncio
    async def test_create_direct_chat_graph_success(self, graph_factory, mock_agent_factory):
    ...
    @pytest.mark.asyncio
    async def test_create_direct_chat_graph_validation_failure(self, graph_factory, mock_agent_factory):
    ...
    @pytest.mark.asyncio
    async def test_execute_direct_chat_new_session(self, graph_factory, mock_agent_factory):
        ...
        with patch.object(graph_factory, 'create_direct_chat_graph') as mock_create_graph:
            mock_graph = Mock()
    ...
    @pytest.mark.asyncio
    async def test_execute_direct_chat_existing_session(self, graph_factory, mock_agent_factory):
    ...
    @pytest.mark.asyncio
    async def test_execute_direct_chat_error_handling(self, graph_factory, mock_agent_factory):
    ...
    def test_validate_graph_structure_missing_agent(self, graph_factory):
        ...
        assert any("Expected agent node 'test_agent' not found" in error for error in result["errors"])
