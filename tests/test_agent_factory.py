...
class TestAgentNodeWrapper:
    ...
    def test_wrapper_creation(self, sample_agent_config, sample_capabilities, mock_model, mock_tools):
    ...
    @pytest.mark.asyncio
    async def test_successful_execution(self, sample_agent_config, sample_capabilities, mock_model, mock_tools, sample_state):
    ...
    @pytest.mark.asyncio
    async def test_validation_failure(self, sample_agent_config, sample_capabilities, mock_tools, sample_state):
    ...
    @pytest.mark.asyncio
    async def test_timeout_handling(self, sample_agent_config, sample_capabilities, mock_tools, sample_state):
    ...
    def test_prepare_messages(self, sample_agent_config, sample_capabilities, mock_model, mock_tools, sample_state):
...
class TestAgentFactory:
    ...
    def test_register_agent_config(self, sample_agent_config, sample_capabilities, mock_tools):
        """Test registering agent configuration."""
        factory = AgentFactory()
        
        factory.register_agent_config(sample_agent_config, sample_capabilities, mock_tools)
    ...
    @pytest.mark.asyncio
    async def test_create_agent_node_registered(self, sample_agent_config, sample_capabilities, mock_tools):
        ...
        with patch.object(factory.model_factory, 'list_models', return_value=[]):
            with patch.object(factory.model_factory, 'register_model'):
                with patch.object(factory.model_factory, 'get_model', return_value=mock_model):
    ...
    @pytest.mark.asyncio
    async def test_validate_agent_success(self, sample_agent_config, sample_capabilities, mock_tools):
        """Test successful agent validation."""
        factory = AgentFactory()
        factory.register_agent_config(sample_agent_config, sample_capabilities, mock_tools)
        
        # Mock model factory
        with patch.object(factory.model_factory, 'list_models', return_value=["test_agent_model"]):
            with patch.object(factory.model_factory, 'get_model', return_value=MockModel()):
